...
export const appTypePresets = [
    ...
    },
    {
        ...
        category: 'Apps & Tools',
        name: 'Dashboard',
        description: 'A data-driven dashboard with charts, stats, and management tools.',
        stack: ['Canva Code', 'Google Apps Script', 'Google Sheets'],
        fileStructure: 'canva-gas',
    },
    {
        id: 'quiz-personality-test',
        category: 'Apps & Tools',
        name: 'Quiz / Personality Test',
        description: 'An interactive quiz or personality test that saves responses and shows results.',
        stack: ['Canva Code', 'Google Apps Script', 'Google Sheets'],
        fileStructure: 'canva-gas',
    },
    {
        id: 'interactive-game',
        category: 'Apps & Tools',
        name: 'Interactive Game / Fun App',
        description: 'A simple interactive game or fun tool built with web technologies.',
        stack: ['Canva Code', 'Google Apps Script'],
        fileStructure: 'canva-gas',
    },
    {
        id: 'generator-tool',
        category: 'Apps & Tools',
        name: 'Generator / Random Tool',
        description: 'A tool that generates specific outputs or random items based on inputs.',
        stack: ['Canva Code', 'Google Apps Script'],
        fileStructure: 'canva-gas',
    },
    {
        id: 'interactive-card',
        category: 'Apps & Tools',
        name: 'Interactive Card / Frame',
        description: 'A digital card or frame with interactive elements and sharing options.',
        stack: ['Canva Code', 'Google Apps Script'],
        fileStructure: 'canva-gas',
    },
    {
        id: 'countdown-utility',
        category: 'Apps & Tools',
        name: 'Countdown / Utility Tool',
        description: 'A specialized utility tool like a countdown timer, calculator, or converter.',
        stack: ['Canva Code', 'Google Apps Script'],
        fileStructure: 'canva-gas',
    },
    {
        ...
        description: 'A dedicated form for collecting structured information and files.',
        stack: ['Canva Code', 'Google Apps Script', 'Google Sheets'],
        fileStructure: 'canva-gas',
    },
]
